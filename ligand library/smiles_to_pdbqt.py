...
input_csv = "/Users/ladislavbucek/Desktop/UK/Mgr./1./Meet-U/ligand lib/combined.csv"  # Replace with your CSV file path
...
for index, row in data.iterrows():
    ...
    result = os.system(f'obabel -:"{smiles}" -O {output_pdbqt} --gen3d -xph 7.4')
